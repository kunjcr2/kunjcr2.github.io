        ...
        <section className="relative min-h-screen flex items-center justify-center bg-white pt-20 md:pt-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-6xl mx-auto">
                    <div className="grid place-items-center gap-8 lg:gap-12">
                        ...
                        <div className="text-center space-y-6 max-w-3xl mx-auto">
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <div className="flex items-center justify-center lg:justify-center gap-2 flex-wrap mb-4">
                                ...
                                {/* Social Links (centered, evenly spaced) */}
